<?php
    ...
    $siteTokens['[confirmation_page]'] = '/free-estimate/confirmation.html';
$siteTokens['[service_dropdown]'] = '
    <option value="" disabled selected>Choose a service</option>
    <option value="crawl">Crawl Space Repair</option>
    <option value="foundation">Foundation Repair</option>
    <option value="waterproofing" >Basement Waterproofing</option>
    <option value="sumppump">Sump Pump Installation</option>
    <option value="airPurifier">Air Purifier</option>
    <option value="electrical">Electrical</option>
    <option value="other">I\'m not sure</option>
';
$siteTokens['[contact_reviews]'] = '
<div id="contact__reviews" class="bg-brand-light border-y border-gray-200">
    <h3 class="text-brand text-xl font-semibold text-center px-4">Reviews from Homeowners Like You!</h3>
    <div>
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="rounded-lg bg-white p-8 shadow-xl">
            <div class="mb-3 flex gap-0.5">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.1443 9.40884C23.0183 9.02934 22.6665 8.76084 22.2525 8.76084H15.1013L12.8918 1.96059C12.7358 1.61634 12.3953 1.38159 12.0008 1.38159C11.6063 1.38159 11.265 1.61634 11.112 1.95459L11.1098 1.96059L8.90026 8.76084H1.74976C1.23226 8.76084 0.812256 9.18084 0.812256 9.69834C0.812256 10.0088 0.963756 10.2848 1.19626 10.4551L1.19926 10.4566L6.98401 14.6588L4.77451 21.4598C4.74526 21.5468 4.72876 21.6466 4.72876 21.7501C4.72876 22.2676 5.14876 22.6876 5.66626 22.6876C5.87326 22.6876 6.06451 22.6208 6.21976 22.5068L6.21676 22.5083L12.0023 18.3046L17.787 22.5083C17.9393 22.6201 18.1305 22.6868 18.3375 22.6868C18.8558 22.6868 19.2758 22.2668 19.2758 21.7486C19.2758 21.6451 19.2593 21.5453 19.2278 21.4523L19.23 21.4591L17.0198 14.6596L22.806 10.4566C23.0415 10.2833 23.1923 10.0081 23.1923 9.69684C23.1923 9.59409 23.1758 9.49434 23.145 9.40209L23.1473 9.40884H23.1443Z" fill="#FFBD13"></path>
                </svg>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.1443 9.40884C23.0183 9.02934 22.6665 8.76084 22.2525 8.76084H15.1013L12.8918 1.96059C12.7358 1.61634 12.3953 1.38159 12.0008 1.38159C11.6063 1.38159 11.265 1.61634 11.112 1.95459L11.1098 1.96059L8.90026 8.76084H1.74976C1.23226 8.76084 0.812256 9.18084 0.812256 9.69834C0.812256 10.0088 0.963756 10.2848 1.19626 10.4551L1.19926 10.4566L6.98401 14.6588L4.77451 21.4598C4.74526 21.5468 4.72876 21.6466 4.72876 21.7501C4.72876 22.2676 5.14876 22.6876 5.66626 22.6876C5.87326 22.6876 6.06451 22.6208 6.21976 22.5068L6.21676 22.5083L12.0023 18.3046L17.787 22.5083C17.9393 22.6201 18.1305 22.6868 18.3375 22.6868C18.8558 22.6868 19.2758 22.2668 19.2758 21.7486C19.2758 21.6451 19.2593 21.5453 19.2278 21.4523L19.23 21.4591L17.0198 14.6596L22.806 10.4566C23.0415 10.2833 23.1923 10.0081 23.1923 9.69684C23.1923 9.59409 23.1758 9.49434 23.145 9.40209L23.1473 9.40884H23.1443Z" fill="#FFBD13"></path>
                </svg>
            ...
            <p class="mb-2 text-sm font-light italic leading-snug lg:text-base">I\'m just so thankful!!! They were great! The old insulation in the crawlspace was falling to pieces and the cold this brought wasn\'t good for my health. My joints were really stiff and painful. After the job was finished, it went away after a couple of days. I am definitely getting more energy and feeling better.  So excited about what the next few months will bring after all the scare I went through! Thank you so much for giving me some peace of mind again. I am SO relieved.  </p>
            <p class="text-sm font-bold">Tiffany<br>Camas, WA</p>
            </div>
            <div class="rounded-lg bg-white p-8 shadow-xl">
            <div class="mb-3 flex gap-0.5">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="mb-2 text-sm font-light italic leading-snug lg:text-base">Chase is great! After our basement flooded twice, we had John\'s Waterproofing install a pump in the basement. No more worries, it works great! We also appreciate the reminder calls to schedule our maintenance apt.</p>
            <p class="text-sm font-bold">Jeanne<br>Gresham, OR</p>
            </div>
            <div class="rounded-lg bg-white p-8 shadow-xl">
            <div class="mb-3 flex gap-0.5">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="mb-2 text-sm font-light italic leading-snug lg:text-base">Communication with the rep, Jake, was great and the head installer, Lupe, was a tremendous worker, setting the example for his team. They worked hard and long!!</p>
            <p class="text-sm font-bold">Kristine<br>Vancouver, WA</p>
            </div>
        </div>
    </div>
</div>
