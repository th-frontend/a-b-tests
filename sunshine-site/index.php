...
<div id="contact__reviews" class="bg-brand-light border-y border-gray-200">
    <h3 class="text-brand text-xl font-semibold text-center px-4">What Our Customers Say</h3>
    <div>
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="rounded-lg bg-white p-8 shadow-xl">
                <p class="mb-2 text-sm font-light italic leading-snug lg:text-base">Sunshine Foundation Repair offers efficient, effective foundation repairs and more in Jacksonville and beyond.</p>
                <p class="text-sm font-bold">Jacksonville, FL</p>
            </div>
            <div class="rounded-lg bg-white p-8 shadow-xl">
                <p class="mb-2 text-sm font-light italic leading-snug lg:text-base">We proudly serve homeowners throughout Greater Jacksonville, including St. Augustine and Middleburg.</p>
                <p class="text-sm font-bold">Greater Jacksonville Area</p>
            </div>
        </div>
    </div>
</div>
...
<!-- Hero 3 Step Form -->
        ...
        @media (width >= 641px){
            ...
            <div id="hero-img">
            <img src="https://cdn.treehouseinternetgroup.com/cms_images/3351/lj_sunshine_fr-mm.png" alt="Larry Janesky Owner of Sunshine Foundation Repair"><div id="main-text">
                <h2>Greater Jacksonville's Crawl Space &amp; Foundation Repair Experts</h2>
                ...
                <picture>
                    <source srcset="https://cdn.treehouseinternetgroup.com/cms_images/3351/lj_sunshine_fr-mm.png" media="(min-width: 641px)">
                    <source srcset="https://cdn.treehouseinternetgroup.com/cms_images/3351/lj-sunshine-300w.png" media="(max-width: 640px)">
                    <img src="https://cdn.treehouseinternetgroup.com/cms_images/3351/lj_sunshine_fr-mm.png" alt="Larry Janesky Owner of Sunshine Foundation Repair" width="360" height="383" decoding="async" fetchpriority="high">
                </picture>
            </div>
            ...
            <div id="hero-form">
                <div id="hero-form-header">
                    ...
                    <p class='hero-form-title'>Greater Jacksonville's Crawl Space & Foundation Repair Experts</p>
                    <p class="hero-form-details">Request your free evaluation today!</p>
